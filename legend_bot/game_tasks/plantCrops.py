            ...
            if (wait(r"legend_bot\images\plant_crops\windowBar.png", timeout=60, confidence=0.8, region=TOP_BAR) and self.running):
                if exists(r"legend_bot\images\plant_crops\farmButton.png", confidence=0.8, region=BOTTOM_RIGHT) and self.running:
                    ...
                    if wait(r"legend_bot\images\plant_crops\farmWindowBar.png", timeout=60, confidence=0.8, region=TOP_BAR) and self.running:
                        if exists(r"legend_bot\images\plant_crops\returnHomeButton", confidence=0.8, region=BOTTOM_RIGHT) and self.running:
                            click(r"legend_bot\images\plant_crops\returnHomeButton", confidence=0.8, region=BOTTOM_RIGHT) 
                            wait_time(3)
                        if exists(r"legend_bot\images\plant_crops\colectCropIndicator.png", confidence=0.8, region=BOTTOM_RIGHT) and self.running:
                            ...
                            wait_time(5)
                        if exists(r"legend_bot\images\plant_crops\optionsMenu.png", confidence=0.8, region=BOTTOM_RIGHT) and self.running:
                            ...
                            if wait(r"legend_bot\images\plant_crops\storeWindowBar.png", timeout=60, confidence=0.8, region=TOP_BAR) and self.running:
                                ...
                                wait_time(3)
                                bar=find(r"legend_bot\images\plant_crops\storeWindowBar.png", confidence=0.8, region=TOP_BAR)
                                click(r"legend_bot\images\plant_crops\storeExitButton.png", confidence=0.8, region=bar)
                                wait_time(2)
                                bar=find(r"legend_bot\images\plant_crops\farmWindowBar.png", confidence=0.8, region=TOP_BAR)
                                click(r"legend_bot\images\plant_crops\farmExitButton.png", confidence=0.8, region=bar)
                                wait_time(2)
                                bar=find(r"legend_bot\images\plant_crops\windowBar.png", confidence=0.8, region=TOP_BAR)
                                click(r"legend_bot\images\plant_crops\exitButton.png", confidence=0.8, region=bar)
                                wait_time(2)
